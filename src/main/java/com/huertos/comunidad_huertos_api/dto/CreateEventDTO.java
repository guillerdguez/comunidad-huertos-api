package com.huertos.comunidad_huertos_api.dto;
...
/**
 * DTO para la creación de un Event. - POJO JavaBean (constructor sin args,
 * getters/setters). - Validación vía Jakarta Bean Validation.
 */
public class CreateEventDTO {
	...
	public CreateEventDTO() {
		// Constructor por defecto necesario para Jackson y mapeadores
